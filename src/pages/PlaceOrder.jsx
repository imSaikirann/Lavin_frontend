...
const PlaceOrder = () => {
    ...
    return (
        <div className='flex flex-col sm:flex-row justify-between gap-6 pt-8 sm:pt-14 min-h-[80vh] border-t px-4'>
            ...
            <div className='flex flex-col gap-6 w-full sm:max-w-[480px]'>
                ...
                <div className='flex gap-4'>
                    <input
                        ...
                        className='border border-gray-300 rounded py-2 px-4 w-full focus:outline-none focus:border-blue-500'></input>
                    <input
                        type="text"
